...
import "./Slide.scss";
import Ocean3 from "../img/OceanJpg/Ocean3.jpg";
    ...
    <div className="Slide__content">
      <Carousel fade>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://images.pexels.com/photos/127160/pexels-photo-127160.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="Second slide"
          />
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={Ocean3} alt="Third slide" />
